 ...
 *
 * SCAFFOLD — Medien im Theme: img/fisiorest*.
 */
if ( ! defined( 'ABSPATH' ) ) { exit; }

// 1) "Wissenschaftlich fundiert" — 4 Karten.
$fis_science = array(
    array( 'title' => 'Nackenbuckel',        'text' => 'Die Traktion <strong>löst den Druck und stellt die richtige Haltung wieder her</strong>, um den durch den „Handy-Nacken" bedingten Buckel zu reduzieren.' ),
    array( 'title' => 'Nackenschmerzen',     'text' => '<strong>Löst Muskelknoten und Verspannungen</strong> und <strong>richtet die Nackenkrümmung neu aus</strong> für schnelle Schmerzlinderung.' ),
    array( 'title' => 'Erholsamer Schlaf',   'text' => 'Die beruhigende Therapie <strong>entspannt Nacken und Wirbelsäule</strong> für tiefen und erfrischenden Schlaf.' ),
...
// 5) ThermoTrac 3-in-1
$fis_thermo = array(
    array( 'vid' => $fis_v.'v10.mp4', 'title' => 'Traktionstherapie' ),
    array( 'vid' => $fis_v.'v07.mp4', 'title' => 'Vibrationstherapie' ),
    array( 'vid' => $fis_v.'v05.mp4', 'title' => 'Wärmetherapie' ),
);
// 6) Vier Verbesserungen
$fis_upgrades = array(
    array( 't' => 'Wiederaufladbarer Akku',   'd' => 'Nehmen Sie ihn überallhin mit — der 2500-mAh-Akku hält bis zu 2 Stunden.' , 'ico' => 'battery-v2.png' ),
    array( 't' => 'Bezug aus Maulbeerseide',  'd' => 'Umhüllt von kühlender Seide für ein weiches, luxuriöses Gefühl.' , 'ico' => 'silk-v2.png' ),
    array( 't' => 'Abschaltung nach 30 Min.', 'd' => 'Vier Anwendungen à 30 Minuten pro Ladung, ganz ohne Sorgen.' , 'ico' => 'timer-v2.png' ),
    array( 't' => 'Regulierte Wärme',         'd' => 'Erwärmung auf 50 °C mit fortschrittlicher ThermoTrac-Technologie.' , 'ico' => 'heat-v2.png' ),
);
?>
...
<section class="fis-science">
  <div class="fis-wrap">
    <div class="fis-box">
      <h2 class="fis-title">Wissenschaftlich fundiert: nachweisliche Linderung für die Nackenpflege</h2>
      <div class="fis-grid">
...
<section class="fis-hero">
  ...
  <div class="fis-hero-inner">
    <h2 class="fis-hero-title">Erleben Sie einen tiefen Neustart durch die vereinte Kraft von Ausrichtung und Entspannung</h2>
  </div>
</section>
...
<section class="fis-experts">
  <div class="fis-wrap fis-exp-grid">
    <div class="fis-exp-quote">
      <h2 class="fis-h2">Von Experten empfohlen</h2>
      <p>„NORIKS ist eines der besten Nackenkissen, die derzeit auf dem Markt sind. Da ich seit über 25 Jahren in der Wellness-Branche tätig bin, habe ich verschiedene Nackenkissen getestet, und was NORIKS auszeichnet, ist die Traktionsfunktion…</p>
      <p>Wenn Sie einen vorgeschobenen Kopf oder eine „gebeugte Haltung" haben, kann die Traktion helfen, die Wirbel wieder auszurichten und den Körper vollständig zu unterstützen. Ich benutze es selbst und empfehle es meinen Kundinnen und Kunden!"</p>
      <p class="fis-exp-author"><strong>Marina Bauer</strong><br>Zertifizierte Massagetherapeutin</p>
    </div>
...
<section class="fis-thermo">
  <div class="fis-wrap">
    ...
    <h2 class="fis-h2 fis-center">Erleben Sie die 3-in-1-Therapie für den Nacken</h2>
...
<section class="fis-upg">
  <div class="fis-wrap">
    <h2 class="fis-h2 fis-center">Vier große Verbesserungen</h2>
...
<section class="fis-cheaper">
  <div class="fis-wrap fis-row2">
    ...
    <div class="fis-row2-copy">
      ...
      <p>NORIKS amortisiert sich in Tagen, nicht in Monaten. Von Therapeuten empfohlen, bietet es sanfte Linderung ohne groben Druck oder riskante Eingriffe. Verwenden Sie es jeden Abend. Ohne Terminvereinbarung. Ohne Anfahrt. Ohne wiederkehrende Kosten — nur sichere, konsequente Nackenpflege, wann immer Sie sie brauchen.</p>
    </div>
  </div>
</section>
...
<style>
  ...
  /* 1) Wissenschaftlich fundiert — graue Karte */
  ...
  /* Kein "Größentabelle"-Link bei FisioRest (identisch wie bunion). */
  .noriks-global-sizechart, .gck-size-link, .gck-size-link-wrap,
  #open-size-chart, #open-size-chartCustom { display: none !important; }

  /* Kurzbeschreibung: Standard-Punkte (•) ausblenden, Abstände. */
...
<script>
/* Oranger active bundle-option via inline !important (überlebt LiteSpeed UCSS). */
(function(){
  function paintOrto(){
