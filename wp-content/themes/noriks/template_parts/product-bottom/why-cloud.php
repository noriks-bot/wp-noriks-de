 ...
 *   1. Holen Sie sich die Morgen zurück, die Sie verloren glaubten   11_jutra
 ...
 *   7. Nicht alle Kniekissen sind gleich                      05
...
<section class="ncd-sec ncd-dark">
  <div class="ncd-wrap ncd-row2">
    ...
    <div class="ncd-copy">
      <h2 class="ncd-h2">Der Unterschied, den Sie schon in der ersten Nacht spüren</h2>
      <p><strong>Ohne Kissen:</strong> das obere Bein fällt über das untere, das Becken verdreht sich und der Druck landet im unteren Rücken und in den Knien.</p>
      <p><strong>Mit NORIKS Cloud:</strong> bleiben die Beine in einer Linie mit den Hüften, das Gewicht verteilt sich und Druckpunkte verschwinden.</p>
      <ul class="ncd-check">
        <li>Hüften und Knie in natürlicher Linie</li>
        <li>Weniger Druck auf den unteren Rücken</li>
        <li>Weniger Herumwälzen in der Nacht</li>
      </ul>
    </div>
  </div>
</section>
...
<section class="ncd-sec">
  <div class="ncd-wrap ncd-center">
    <h2 class="ncd-h2">Schlafen Sie schon heute Nacht besser</h2>
    <p class="ncd-sub">Einfach in der Anwendung. <strong>Besserer Schlaf</strong> ab der ersten Nacht.</p>
  </div>
  <div class="ncd-wrap">
      ...
      <?php foreach ( $cd_steps as $i => $st ) : ?>
        <div class="ncd-step4">
          <div class="ncd-step4-ic">
            ...
            <span class="ncd-step4-b">Schritt <?php echo (int) $i + 1; ?></span>
          </div>
...
<section class="ncd-sec ncd-dark">
  <div class="ncd-wrap ncd-center">
    <h2 class="ncd-h2">Warum Sie mit NORIKS Cloud anders aufwachen</h2>
    <p class="ncd-sub ncd-rate"><span class="ncd-stars">★★★★★</span> Bewertung <strong>4,8/5</strong> Tausend zufriedene Kunden</p>
  </div>
  <div class="ncd-wrap">
    <div class="ncd-revs">
...
<section class="ncd-sec">
  <div class="ncd-wrap ncd-row2">
    <div class="ncd-copy">
      <p class="ncd-eyebrow">Seitenschlaf</p>
      <h2 class="ncd-h2">Holen Sie sich die Morgen zurück, die Sie verloren glaubten</h2>
      <p>Sie kennen das Gefühl: Sie wachen steif auf, suchen die ganze Nacht eine schmerzfreie Position oder wachen mehrmals ohne Grund auf.</p>
...
<section class="ncd-sec ncd-dark">
  <div class="ncd-wrap ncd-row2">
    <div class="ncd-copy">
      <h2 class="ncd-h2">Die Ausrichtung, die Sie morgens spüren</h2>
      ...
      <ul class="ncd-check">
        <li>Gerade Wirbelsäule statt verdrehter</li>
        <li>Ausgerichtetes Becken ohne Verdrehung</li>
        <li>Getrennte Knie, ohne Druck</li>
      </ul>
    </div>
...
<?php
$cd_cases = array(
  array( 'cld-case-bok.webp',       'Seitenschlaf', 'Prilagođeno vašem prirodnom položaju.' ),
...
<section class="ncd-sec">
  <div class="ncd-wrap ncd-center">
    <h2 class="ncd-h2">Entwickelt für das, was Sie am Schlafen hindert</h2>
    <p class="ncd-sub">Sechs Situationen, in denen das Kniekissen den größten Unterschied macht.</p>
  </div>
  <div class="ncd-wrap">
    <div class="ncd-cases">
...
<section class="ncd-sec ncd-dark">
  <div class="ncd-wrap ncd-row2">
    <div class="ncd-copy">
      <h2 class="ncd-h2">Gemacht, um zu atmen</h2>
      <p>Memory-Schaum in medizinischer Qualität mit eingearbeiteten Perforationen — fest genug, um den Abstand zu halten, weich genug, um sich anzupassen.</p>
      <ul class="ncd-check">
        <li><strong>Waschbarer Bezug</strong> — atmungsaktives Gewebe, sanft zur Haut</li>
        <li><strong>Die Perforationen</strong> halten den Schaum die ganze Nacht frisch</li>
        <li><strong>Behält die Form</strong> über Jahre, ohne durchzuliegen</li>
      </ul>
    </div>
...
<section class="ncd-sec">
  <div class="ncd-wrap ncd-row2">
    ...
    <div class="ncd-copy">
      <h2 class="ncd-h2">Nicht alle Kniekissen sind gleich</h2>
      <ul class="ncd-vs">
        <li class="is-no"><strong>Ohne Band</strong><span>rutscht heraus, sobald Sie sich drehen</span></li>
        <li class="is-no"><strong>Das Loch in der Mitte</strong><span>stört die Durchblutung</span></li>
        <li class="is-no"><strong>Liegt durch</strong><span>nach wenigen Wochen</span></li>
        <li class="is-yes"><strong>Verstellbares Band</strong><span>bleibt genau da, wo es soll</span></li>
        <li class="is-yes"><strong>Volle, ergonomische Form</strong><span>ohne Löcher und Hohlräume</span></li>
        <li class="is-yes"><strong>Schaum in medizinischer Qualität</strong><span>behält die Form über Jahre</span></li>
      </ul>
    </div>
  </div>
</section>
...
<section class="ncd-sec ncd-dark">
  <div class="ncd-wrap ncd-row2">
    <div class="ncd-copy">
      <h2 class="ncd-h2">Nach strengen Standards gefertigt</h2>
      <p>Die Materialien sind auf Schadstoffe geprüft und der Schaum ist zertifiziert. Das Design folgt Schweizer Qualitätsstandards.</p>
      <ul class="ncd-check">
        <li><strong>OEKO-TEX® STANDARD 100</strong> — ohne Schadstoffe</li>
        <li><strong>CertiPUR-EU</strong> — zertifizierter Memory-Schaum</li>
        <li><strong>In der Schweiz entworfen</strong>, nach europäischen Standards produziert</li>
      </ul>
    </div>
...
<section class="ncd-sec">
  <div class="ncd-wrap ncd-row2">
    <div class="ncd-copy">
      <p class="ncd-eyebrow">Ohne Risiko</p>
      <h2 class="ncd-h2">60 Nächte zum Testen</h2>
      <p>Testen Sie es selbst. Ist NORIKS Cloud nichts für Sie, erstatten wir den vollen Betrag — ohne Bedingungen und ohne Papierkram.</p>
      <a class="ncd-cta" href="#bundle-selector">NORIKS Cloud bestellen</a>
    </div>
    <div class="ncd-media"><?php echo $cd_img('cld-60-noci.webp','60 Nächte zum Testen'); ?></div>
  </div>
</section>
