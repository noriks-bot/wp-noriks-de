...
$nhy_marquee = array(
  ...
  array( 'beskraj', 'Dauerfilter, bez zamjena' ),
...
<!-- ============ 2) Sehen Sie, wie es perlt ============ -->
<section class="nhy-sec">
  <div class="nhy-wrap">
    <h2 class="nhy-h2 nhy-center">Sehen Sie, wie es perlt</h2>
    <p class="nhy-fizz-text">Sehen Sie die kräftigen Bläschen, die bei der Elektrolyse entstehen — das ist reine Wasserstoffanreicherung in Bestform. Das Wasser bleibt dabei klar und erfrischend nach jedem Zyklus.</p>
    <div class="nhy-fizz">
...
<!-- ============ 3) Antioxidative Kraft, weniger Entzündungen ============ -->
<section class="nhy-sec nhy-alt">
  <div class="nhy-wrap nhy-row2">
    <div class="nhy-copy">
      <h2 class="nhy-h2">Antioxidative Kraft, weniger Entzündungen</h2>
      <p>Wasserstoffwasser ist für seine starke antioxidative und entzündungshemmende Wirkung bekannt, die in wissenschaftlichen Studien mit Vorteilen bei über 150 Zuständen in Verbindung gebracht wird.</p>
      <p>Klinische Studien zeigten außerdem, dass drei Flaschen Wasserstoffwasser eine antioxidative Wirkung haben können, die dem Verzehr Hunderter Obst- und Gemüsestücke entspricht.</p>
      <p class="nhy-note">Wasserstoffwasser ist eine Ergänzung zur täglichen Flüssigkeitszufuhr, kein Ersatz für eine ärztliche Behandlung.</p>
    </div>
...
<section class="nhy-sec">
  <div class="nhy-wrap nhy-center">
    <h2 class="nhy-h2">Echte Nutzergeschichten</h2>
  </div>
  <div class="nhy-wrap nhy-row2">
    ...
    <div class="nhy-copy">
      <ul class="nhy-stories">
        <li><strong>Regeneration mit mehr Energie</strong><span>„Nakon svakog treninga osjećam manje umora u mišićima. HydraH₂ mi je oporavak učinio jednostavnim."</span></li>
        <li><strong>Sichtbare Hydration</strong><span>„Koža mi je punija i bolje hidrirana. Savršeno za svakodnevnu rutinu."</span></li>
        <li><strong>Praktisch und sauber</strong><span>„Nema okusa plastike, punjenje preko USB-a je jednostavno. Moja svakodnevna boca."</span></li>
      </ul>
    </div>
  </div>
</section>

<!-- ============ 5) Die Vorteile von Wasserstoffwasser ============ -->
<section class="nhy-sec nhy-alt">
  <div class="nhy-wrap nhy-center">
    <h2 class="nhy-h2">Die Vorteile von Wasserstoffwasser</h2>
  </div>
  <div class="nhy-wrap">
    <div class="nhy-perks">
      <div class="nhy-perk"><strong>Bessere Hydration</strong><span>Reichert das Wasser mit hochkonzentriertem Wasserstoff für optimale Hydration an.</span></div>
      <div class="nhy-perk"><strong>Wiederaufladbarer Akku</strong><span>Die USB-Ladung in unter 60 Minuten hält die Flasche den ganzen Tag einsatzbereit.</span></div>
      <div class="nhy-perk"><strong>Dauerfilter</strong><span>Der eingebaute Filter muss nicht gewechselt werden — das spart Zeit und Geld.</span></div>
      <div class="nhy-perk"><strong>Schnelle Zyklen</strong><span>Wählen Sie einen Zyklus von 3 oder 10 Minuten für Ihre passende Wasserstoffdosis.</span></div>
    </div>
  </div>
</section>

<!-- ============ 6) Fortschrittliche Wasserstofferzeugung ============ -->
<section class="nhy-sec">
  <div class="nhy-wrap nhy-row2">
    <div class="nhy-media"><?php echo $nh_img('hyd-04-kako-radi.webp','PEM i SPE elektroliza — proizvodnja vodika'); ?></div>
    <div class="nhy-copy">
      <h2 class="nhy-h2">Fortschrittliche Wasserstofferzeugung</h2>
      <p>Mit erstklassiger <strong>PEM- und SPE-Elektrolyse</strong> erzeugt NORIKS HYD bis zu <strong>3.000 ppb</strong> molekularen Wasserstoff im Wasser. Die Glasflasche mit Edelstahlboden sorgt dafür, dass das Wasser nie mit Kunststoff in Berührung kommt, und der Dauerfilter des Generators macht Wartung überflüssig. Die automatische Entlüftung führt Restgase ab — für sauberes, sicheres Trinken.</p>
      <ul class="nhy-check">
        <li>Titanelektroden mit Platinbeschichtung</li>
        <li>99,99 % reiner Wasserstoff, Nebenprodukte entweichen über die Entlüftung</li>
        <li>Funktioniert mit jedem Trinkwasser, auch mit destilliertem</li>
      </ul>
    </div>
  </div>
</section>
...
<section class="nhy-sec nhy-alt">
  <div class="nhy-wrap nhy-row2">
    <div class="nhy-copy">
      <h2 class="nhy-h2">Bereit, Ihre Hydration auf ein neues Level zu heben?</h2>
      <p>Schließen Sie sich den Tausenden an, die ihre Wellness-Routine mit wasserstoffreichem Wasser aufgewertet haben. Spüren Sie den Energieschub, die bessere Regeneration und sichtbare Hydration.</p>
      <a class="nhy-cta" href="#bundle-selector">NORIKS HYD bestellen</a>
    </div>
