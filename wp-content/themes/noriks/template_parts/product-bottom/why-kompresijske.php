...
<section class="why-section knc-demo">
  <div class="knc-demo-wrap">
    <h2 class="knc-demo-title">So funktioniert es in der Praxis</h2>
...
<section class="why-section knc-compare-section">
  <div class="knc-compare-wrap">
    <h2 class="knc-compare-title">NORIKS vs. andere</h2>
    <div class="knc-table-scroll">
      <table class="knc-table">
        <thead>
          <tr>
            <th class="knc-feat"></th>
            <th class="knc-comp">Klassische Strümpfe<span>(Bauerfeind, medi…)</span></th>
            <th class="knc-comp">TV-Strümpfe<span>(Zip Sox &amp; Co.)</span></th>
            <th class="knc-us">NORIKS<em class="knc-badge">Nr. 1</em></th>
          </tr>
        </thead>
        <tbody>
          <tr><td>Medizinische Kompression</td><td class="ok">✓</td><td class="no">✕</td><td class="us ok">✓</td></tr>
          <tr><td>Reißverschluss zum einfachen Anziehen</td><td class="no">✕</td><td class="ok">✓</td><td class="us ok">✓</td></tr>
          <tr><td>Selbstständiges Anziehen ohne Hilfe</td><td class="no">✕</td><td class="mid">~</td><td class="us ok">✓</td></tr>
  ...
  <div style="max-width: 1440px;" class="container why-container">
    ...
    <div class="why-col">
      <div class="video-wrapper">
        <?php if ( $kn_img_1 ) : ?>
          <img loading="lazy" decoding="async" style="width:100%; aspect-ratio:1/1; object-fit:cover;" src="<?php echo esc_url( $kn_img_1 ); ?>" alt="Kompressionsstrümpfe">
    ...
    <div class="why-col why-content">
      ...
      <div style="margin-left: 20px;" class="why-point">
        <p><strong>Bessere Durchblutung, weniger Müdigkeit</strong></p>
        <p class="description">Die abgestufte Kompression fördert sanft den Blutfluss zum Herzen, reduziert das Schwere- und Müdigkeitsgefühl in den Beinen und hilft, dass die Beine auch am längsten Tag leicht bleiben.</p>
      </div>

      <div style="margin-left: 20px;" class="why-point">
        <p><strong>Weniger Schwellungen</strong></p>
        <p class="description">Ideal für lange Reisen, langes Stehen oder Sitzen. Der gleichmäßige Druck reduziert die Flüssigkeitsansammlung und Schwellungen an Knöcheln und Waden.</p>
      </div>

      <div style="margin-left: 20px;" class="why-point">
        <p><strong>Halt, den man spürt</strong></p>
        <p class="description">Der anatomische Schnitt hält den Strumpf an seinem Platz, ohne oben einzuschnüren. Ein Gefühl von festem, aber angenehmem Halt den ganzen Tag.</p>
      </div>
    </div>
...
<section class="why-section knc-ugc">
  <div class="knc-ugc-wrap">
    <h2 class="knc-ugc-title">Was unsere Kunden sagen</h2>
