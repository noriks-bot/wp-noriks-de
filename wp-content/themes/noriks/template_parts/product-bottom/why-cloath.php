...
<section class="ncl-sec ncl-alt">
  <div class="ncl-wrap ncl-row2">
    <div class="ncl-media"><?php echo $cl_anim('cl-anim-1.mp4','cl-01-hero-3plus3.webp','Dusche reinigen mit dem Polar NORIKS Cloth'); ?></div>
    <div class="ncl-copy">
      <h2 class="ncl-h2">Kristallklare Dusche in unter einer Minute — ohne Chemie, nur Wasser</h2>
      <p>Kämpfen Sie immer noch mit Wasserflecken, Kalk und Seifenresten — selbst nach Abzieher oder billigem Tuch?</p>
      <p>Darum haben wir <strong>Polar NORIKS Cloth</strong> — für alle, die genug haben von Schrubben und teuren Sprays.</p>
      <p>Ein paar schnelle Züge und Glas, Fliesen und Armaturen bleiben makellos. Ohne aggressive Mittel, ohne Streifen, ohne Ärger.</p>
    </div>
  </div>
</section>
...
<section class="ncl-sec">
  <div class="ncl-wrap ncl-row2">
    <div class="ncl-copy">
      <h2 class="ncl-h2">Perfekter Spiegel in Sekunden — ohne Streifen und ohne Mühe</h2>
      <p>Genug von Wasserflecken, Tropfen und Beschlag, die Streifen oder Fusseln hinterlassen?</p>
      <p>Die dichte Strickfläche nimmt Schmutz und Wasser in einem Zug auf, der Spiegel bleibt kristallklar — ohne Spray und ohne Schlieren.</p>
      <p class="ncl-strong">Makelloser Glanz jedes Mal — und ein Tuch, das Wäsche für Wäsche durchhält.</p>
    </div>
    <div class="ncl-media"><?php echo $cl_anim('cl-anim-2.mp4','cl-08-dvostrani.webp','Spiegel streifenfrei wischen'); ?></div>
  </div>
</section>
...
<section class="ncl-sec ncl-alt">
  <div class="ncl-wrap ncl-row2">
    <div class="ncl-media"><?php echo $cl_img('cl-09-zena-krpa.webp','Mit dem Polar NORIKS Cloth gereinigtes Bad'); ?></div>
    <div class="ncl-copy">
      <h2 class="ncl-h2">Ein Bad, das glänzt — ohne einen Finger zu rühren</h2>
      <p>Sauberes Glas, glänzende Armaturen, makelloser Spiegel — ohne Schrubben, Sprays und Stress.</p>
      <p>Dickere, dichtere Fasern nehmen Kalk, Schmutz und Wasserflecken in wenigen Zügen auf — nur mit Wasser.</p>
      <ul class="ncl-check">
        <li>Glas- und Terrassentüren</li>
        <li>Spiegel und große Fenster</li>
        <li>Fliesen, Armaturen und Arbeitsflächen</li>
      </ul>
      <a class="ncl-cta" href="#bundle-selector">Wählen Sie Ihr Paket</a>
    </div>
  </div>
</section>
...
<section class="ncl-sec">
  <div class="ncl-wrap ncl-row2">
    <div class="ncl-copy">
      <h2 class="ncl-h2">Nimmt bis zum 4-fachen seines Gewichts an Wasser auf und lässt Flächen trocken</h2>
      <p>Die meisten Tücher verteilen das Wasser nur. Polar NORIKS Cloth nimmt <strong>bis zu 600 ml</strong> auf einmal auf — fast eine ganze Flasche Wasser.</p>
      <p>Ein paar Züge und Dusche, Fliesen und Armaturen sind trocken. Ohne Streifen, ohne Flecken, ohne Warten.</p>
      <p class="ncl-strong">Das Ergebnis: ein Bad, das länger sauber bleibt — ohne Chaos.</p>
    </div>
    <div class="ncl-media"><?php echo $cl_anim('cl-anim-3.mp4','cl-07-dimenzije.webp','Wasseraufnahme — bis zu 600 ml auf einmal'); ?></div>
  </div>
</section>
...
<section class="ncl-sec ncl-alt">
  <div class="ncl-wrap ncl-row2">
    <div class="ncl-media"><?php echo $cl_anim('cl-anim-4.mp4','cl-02-stack.webp','Das Tuch nach Hunderten Wäschen'); ?></div>
    <div class="ncl-copy">
      <h2 class="ncl-h2">Fusselfrei. Robust. Wäsche für Wäsche.</h2>
      <p>Das Tuch ist für Hunderte Anwendungen gemacht. Ab in die Maschine — und es ist wieder bereit.</p>
      <p>Anders als gewöhnliche Tücher <strong>fusselt es nicht</strong> — keine Fusseln, keine Streifen, kein Ärger.</p>
      <ul class="ncl-check">
        <li>Verblasst nicht und franst nicht aus</li>
        <li>Maschinenwaschbar bei 40 °C</li>
        <li>Zweiseitiges Design: reinigt und poliert</li>
      </ul>
    </div>
  </div>
</section>

<!-- ============ 6) 30 Tage lang jamstva ============ -->
<section class="ncl-sec">
  <div class="ncl-wrap ncl-row2">
    <div class="ncl-copy">
      <p class="ncl-eyebrow">30 Tage ohne Risiko</p>
      <h2 class="ncl-h2">Sie zahlen nur, wenn es Ihnen gefällt</h2>
      <p>Noch skeptisch? Verstehen wir — es klingt zu gut, um wahr zu sein.</p>
      <p>Darum können Sie das Tuch völlig risikofrei testen <strong>30 Tage lang</strong>. Ist das Glas nicht kristallklar, lassen sich die Fliesen nicht leichter pflegen oder gefällt Ihnen das Ergebnis einfach nicht — schicken Sie es zurück.</p>
      <p class="ncl-strong">Entweder Sie bekommen ein Bad, das strahlt wie neu — oder Sie bekommen Ihr Geld zurück.</p>
      <a class="ncl-cta" href="#bundle-selector">Ohne Risiko bestellen</a>
    </div>
    <div class="ncl-media"><?php echo $cl_img('cl-10-zena-lice.webp','30 Tage Geld-zurück-Garantie'); ?></div>
  </div>
</section>
