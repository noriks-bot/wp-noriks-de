...
<?php if ( noriks_has_product_cat( array( 'starter', 'ortho_combo' ), get_the_ID() ) ): ?>  
...
<div id="custom-size-chart-modal" aria-modal="true" role="dialog">
  ...
  <div  style="<?php if ( noriks_has_product_cat( array( 'starter', 'ortho_combo' ), get_the_ID() ) ): ?>  display: block; <?php endif; ?>"
      ...
      <div class="noriks-bx">
        ...
        <div class="noriks-bx-wrap">
          <table class="noriks-bx-t">
            <thead>
              <tr><th>Größe</th><th>S</th><th>M</th><th>L</th><th>XL</th><th>2XL</th><th>3XL</th><th>4XL</th></tr>
            </thead>
            <tbody>
        ...
        <img class="noriks-bx-fig" src="<?php echo esc_url( get_template_directory_uri() . '/img/boxers-measure.webp' ); ?>"
             alt="Boxershorts-Maße: a, b, c, d" loading="lazy">
        <p class="noriks-bx-note"><strong>Wähle dieselbe Größe, die du normalerweise trägst.</strong><br>Die Maße sind in Zentimetern. Die Größen können um &plusmn;1&ndash;2 cm abweichen. Wenn du zwischen zwei Größen liegst, nimm die kleinere &mdash; das Material ist dehnbar.</p>
      </div>
    ...
    style="margin-top: 70px;margin-bottom: 70px;"
      ...
      src="https://noriks.com/de/wp-content/uploads/2026/04/nogavice_de.jpg"
      alt="Size Guide">
      
      
      <?php elseif ( noriks_has_product_cat( array( 'starter', 'ortho_combo' ), get_the_ID() ) ): ?>
    ...
    style="margin-top: 35px;margin-bottom: 0px;"
      ...
      src="https://noriks.com/de/wp-content/uploads/2026/04/tablica_de.jpg"
      alt="Size Guide">
      ...
      <div style="margin:30px 0;padding:0 6px;">
        <p style="margin:0 0 4px;font-weight:700;font-size:15px;">So messen Sie Ihren Hüftumfang</p>
        <p style="margin:0 0 14px;line-height:1.6;font-size:14px;color:#333;">Legen Sie das Maßband um die breiteste Stelle der Hüfte (über das Gesäß), ohne es zu straffen, und notieren Sie das Maß in Zentimetern.</p>
        <table style="width:100%;border-collapse:collapse;font-size:14px;">
          <thead><tr style="background:#12233b;color:#fff;">
            <th style="padding:9px 10px;text-align:left;background:#e9e9e9 !important;color:#111 !important;">Größe</th><th style="padding:9px 10px;text-align:left;background:#e9e9e9 !important;color:#111 !important;">Hüfte (cm)</th>
          </tr></thead>
          <tbody>
          <?php foreach ( array(array('S','bis 76 cm','do 30"'),array('M','77 – 85 cm','30 – 33"'),array('L','86 – 94 cm','34 – 37"'),array('XL','95 – 102 cm','37 – 40"'),array('2XL','103 – 114 cm','41 – 45"'),array('3XL','115 – 121 cm','45 – 48"'),array('4XL','122 – 129 cm','48 – 51"'),array('5XL','130 – 137 cm','51 – 54"'),array('6XL','138 – 145 cm','54 – 57"'),array('7XL','146 – 153 cm','57 – 60"'),array('8XL','154 cm und mehr','61" i više') ) as $i=>$r): ?>
        ...
        <p style="margin-top:12px;font-size:14px;color:#444;"><strong>Zwischen zwei Größen?</strong> Wir empfehlen die größere Größe für optimalen Komfort und maximale Saugkraft.</p>
      </div>
      ...
      <div style="margin:30px 0;padding:0 6px;">
        <table style="width:100%;border-collapse:collapse;font-size:16px;">
          <thead><tr style="background:#111;color:#fff;">
            <th style="padding:11px 12px;text-align:left;background:#e9e9e9 !important;color:#111 !important;">Größe</th><th style="padding:11px 12px;text-align:left;background:#e9e9e9 !important;color:#111 !important;">Passendes Gewicht</th>
          </tr></thead>
          <tbody>
        ...
        <p style="margin-top:12px;font-size:14px;color:#444;">Wählen Sie die Größe nach Ihrem Gewicht. Zwischen zwei Größen? Für stärkere Kompression wählen Sie die kleinere Größe.</p>
      </div>

      <?php else: ?>

      <!-- T-SHIRTS: HTML Groessentabelle (Groesse x Gewicht) -->
      <div class="noriks-size-chart-wrap">
          ...
          <table class="noriks-sc">
            <thead>
              <tr>
                ...
                <th class="noriks-sc-empty" style="width:80px;">Größe</th>
                <th>59-68 kg</th>
                <th>69-77 kg</th>
                <th>78-84 kg</th>
                <th>84-95 kg</th>
            ...
            <tbody>
              <tr>
                <th class="noriks-sc-vis-label" rowspan="11">Größe (cm)</th>
                <th>168 cm</th>
        ...
        <div class="noriks-sc-steps">
          <h3>So findest du deine Größe</h3>
          <div class="noriks-sc-steps-grid">
            <div class="noriks-sc-step">
              <span class="noriks-sc-num">1</span>
              <span>Finde deine <strong>Körpergröße</strong> in der linken Spalte.</span>
            </div>
            <div class="noriks-sc-step">
              <span class="noriks-sc-num">2</span>
              <span>Finde dein <strong>Gewicht</strong> in der oberen Zeile.</span>
            </div>
            <div class="noriks-sc-step">
              <span class="noriks-sc-num">3</span>
              <span>Wo sie sich treffen &mdash; das ist deine Größe.</span>
            </div>
          </div>
        </div>
        ...
        <div class="noriks-sc-pro">
          ...
          <span>Wenn du zwischen zwei Größen liegst und einen <strong>lockereren Sitz</strong> möchtest, nimm die größere. Für einen <strong>engeren Sitz</strong> die kleinere.</span>
        </div>
