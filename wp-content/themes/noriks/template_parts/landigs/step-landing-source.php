...
<meta name='robots' content='index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1' />
	...
	<meta property="og:description" content="✔ Sofortige Entlastung ✔ Klinisch getestet ✔ Von Podologen empfohlen" />
    ...
    ////////////////////////////////////////
        ...
        //////////////////////////////////////
					...
					<div class="sct-hero__dyn-properties scroll-target">
                      ...
                      <div class="colors-container">
                        <div class="color-name-wrapper">
                          <label id="selected-color-variation-name" variation-index="0">Farbe: </label><label id="selected-color-variation-value"></label>
                        </div>
              ...
              <div class="other-property-name">
                <label class="other-property-label">Groesse
                </label>
              </div>
...
<div class="quantity-banner">Najbolj&#x161;a ponudba</div>
        ...
        <div class="add-to-cart-button-container">
          <a id="checkout_add_to_cart_btn" class="checkout-add-to-cart-btn" href="https://ortowp.noriks.com/kosarica/?add-more=">
              <span id="checkout_add_to_cart_btn_text" class="checkout-add-to-cart-btn-text"><img src="https://images.hs-plus.com/assets/shared-images/adafec52191b3_cart_icon.svg"><p class="checkout-add-to-cart-order-text">In den Warenkorb</p></span>
        ...
        <style>
          ...
          <div class="related-product-wrapper">
            <span class="related-product-text">Zusammen kaufen und sparen:</span>
              ...
              <div class="related-product-checkbox-container">
                <label class="related-product-container">
                  ...
                  <span class="checkmark" id="checkmark-rp-0">
                    <p>
                      <span class="add-purchase-text add-related" id="atc-text-rp-0">Zum Kauf hinzufuegen</span>
					...
					<div class="acrd">
						...
						<details class="acrd__item">
							...
							<div class="acrd__body">
								...
								<ol>
									<li><strong>Legen Sie eine Groesse in den Warenkorb.</strong></li>
									<li><strong>Legen Sie noch eine weitere Groesse in den Warenkorb.</strong></li>
								</ol>
							...
							<div class="swiper-wrapper">
								...
								<div class="swiper-slide loockat-slider__item loockat-card">
									...
									<div class="loockat-card__info">
										...
										<h4 class="loockat-card__title">Bauarbeiter</h4>
				...
				<div class="sct-ebook__content">
					<div class="sct-ebook__top">
						...
						<div class="sct-ebook__top-content">
							...
							<p class="sct-ebook__text">Entdecken Sie wertvolle Tipps mit unserem exklusiven E-Book, komplett kostenlos zu jeder Bestellung.</p>
						</div>
					</div>
					<div class="sct-ebook__card">
						<span class="sct-ebook__card-badge">E-Book</span>
						<div class="sct-ebook__card-title_box">
							<h3 class="sct-ebook__card-title">Fussgesundheit verstehen: Ihr Leitfaden fuer gesunde Fuesse</h3>	
						</div>
						<p class="sct-ebook__card-text"><span>KOSTENLOS</span> zu jeder Bestellung</p>
						<ul class="sct-ebook__card-list">
							<li class="sct-ebook__card-item">Umfassendes Wissen ueber die Fussgesundheit</li>
							<li class="sct-ebook__card-item">Erklaerung der Vorteile von Einlegesohlen</li>
							<li class="sct-ebook__card-item">Anwendung von Techniken zur Fusspflege</li>
							<li class="sct-ebook__card-item">Empfehlungen fuer die taegliche Pflege</li>
							<li class="sct-ebook__card-item">Ganzheitliches Wohlbefinden fuer Ihre Fuesse</li>
						</ul>
						<button class="btn-arw results__btn sct-ebook__btn" data-scroll=".scroll-target" data-scroll-offset="120"><span>ANGEBOT ANFORDERN</span></button>
					</div>
				</div>
			</div>
		</section>
    ...
    <div class="review-modal-content">
        ...
        <div class="review-modal-body">
            ...
            <form id="review-form" action="https://diwpk57gr7.execute-api.eu-central-1.amazonaws.com/prod/submitReview" enctype="multipart/form-data" method="POST" target="formFrame">
                <p><label class="review-form__label" for="name">Name:</label></p>
                <p><input class="review-form__input" name="name" type="text" maxlength="40" placeholder="Name (oeffentlich sichtbar)" required></p>
