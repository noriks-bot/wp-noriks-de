<?php
/**
 * Tablica velicina za NORIKS FIT Woman (orto-kompwom) — trg DE.
...
<div id="custom-size-chart-modal" class="kwsc" role="dialog" aria-modal="true" aria-labelledby="kwsc-title">
  <div class="kwsc-box">
  <div class="kwsc-bar">
    <h2 id="kwsc-title">Größentabelle</h2>
    <span id="close-size-chart-x" role="button" tabindex="0" aria-label="Schließen">&times;</span>
  </div>

  <div class="kwsc-body">
    <p class="kwsc-lead">Wählen Sie die Größe nach dem <strong>Brustumfang</strong> — er entscheidet, wie das Shirt an Brust und Schultern sitzt. Wenn Sie zwischen zwei Größen liegen, nehmen Sie die <strong>größere</strong>.</p>


    <div class="kwsc-scroll">
      <table class="kwsc-table">
        <thead>
          <tr><th scope="col">Größe</th><th scope="col">Brustumfang</th><th scope="col">Taillenumfang</th></tr>
        </thead>
        <tbody>
    ...
    <div class="kwsc-how">
      <h3>So messen Sie</h3>
      <ol>
        <li><strong>Brust</strong> — über die breiteste Stelle der Brust, das Band waagerecht um den Körper.</li>
        <li><strong>Taille</strong> — die schmalste Stelle der Taille, meist etwas oberhalb des Bauchnabels.</li>
        <li><strong>Wählen Sie die Zeile</strong>, in der beide Werte liegen; fallen sie in zwei Zeilen, nehmen Sie die größere Größe.</li>
      </ol>
      <p class="kwsc-note">Messen Sie über der Unterwäsche, nicht über der Kleidung. Das Band soll anliegen, aber nicht einschnüren.</p>
    </div>
  </div>
  </div>
</div>
