<?php
/**
 * Template Name: Gebrauchsanleitungen
 *
...
<div class="nmn">
  <div class="nmn-wrap">
    ...
    <p class="nmn-sub">Laden Sie die Anleitung für Ihr NORIKS Produkt als PDF herunter.</p>
    ...
    <div class="nmn-search">
      ...
      <input type="search" id="nmn-q" placeholder="Nach Produktname suchen…" autocomplete="off">
    </div>
          ...
          <div class="nmn-body">
            ...
            <p class="nmn-links">
              <a class="nmn-btn" href="<?php echo esc_url( $dir_url . $m['file'] ); ?>" target="_blank" rel="noopener">
                PDF herunterladen <span>(<?php echo esc_html( $size ); ?>)</span>
              </a>
              <?php if ( $p['url'] ) : ?>
                <a class="nmn-link" href="<?php echo esc_url( $p['url'] ); ?>">Produktseite</a>
              <?php endif; ?>
            </p>
          </div>
        </div>
    ...
    <p class="nmn-empty" id="nmn-empty" hidden>Keine Anleitung zu diesem Begriff. Schreiben Sie uns an <a href="mailto:info@noriks.com">info@noriks.com</a>.</p>
    <p class="nmn-help">Brauchen Sie Hilfe mit einem Produkt? Schreiben Sie uns an <a href="mailto:info@noriks.com">info@noriks.com</a>.</p>
  </div>
</div>
