	...
	acf_add_local_field_group( array(
		...
		'fields' => array(
			array(
				...
				'label'        => 'Upsell unter dem Button anzeigen (3x Blaue Boxershorts)',
				'name'         => 'noriks_pp_upsell',
				'type'         => 'true_false',
				'instructions' => 'Fügt die Box "Zusammen kaufen und sparen" direkt unter dem Button In den Warenkorb ein. Der Kunde wählt die Größe, 3 Stück werden zum Upsell-Preis hinzugefügt. Gilt nur für dieses Produkt.',
				'ui'           => 1,
			),
		),
		'location'   => array(
...
function noriks_pp_upsell_config() {
	return apply_filters( 'noriks_pp_upsell_config', array(
		...
		'total'      => 19.99,                   // ista cijena kao thank you upsell (3 x 4,99)
		'title'      => '3x Blaue Boxershorts',
