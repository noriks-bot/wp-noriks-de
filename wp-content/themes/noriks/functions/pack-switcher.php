 ...
 *   DE  6er-set-t-shirts  (Eltern: t-shirts)
...
function noriks_render_pack_switcher() {
    ...
    <div class="npk">
        ...
        <?php if ( $shown > 1 ) : ?>
        <div class="npk-block">
            <div class="npk-label"><?php esc_html_e( 'Paket wählen', 'noriks' ); ?></div>
                    ...
                    <a class="npk-size<?php echo $is_cur ? ' is-active' : ''; ?>"
                       ...
                       <?php echo $is_cur ? 'aria-current="true"' : ''; ?>>
                        <span class="npk-size-n"><?php
                            if ( (int) $s === 1 ) {
                                esc_html_e( '1 Stück', 'noriks' );
                            } else {
                                echo (int) $s; ?><?php esc_html_e( 'er-Set', 'noriks' );
                            } ?></span>
                        <span class="npk-size-p"><?php echo wp_kses_post( wc_price( $ppu ) ); ?><span class="npk-size-u"><?php esc_html_e( '/ St.', 'noriks' ); ?></span></span>
                    </a>
                <?php endforeach; ?>
            </div>
        ...
        <?php if ( count( $same ) > 1 ) : ?>
        <div class="npk-block">
            <div class="npk-label"><?php esc_html_e( 'Farbe', 'noriks' ); ?></div>
            <div class="npk-scroll">
