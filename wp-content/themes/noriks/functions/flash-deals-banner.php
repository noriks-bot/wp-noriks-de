...
const NORIKS_FLASH_CAT   = 'sommer-sale';
...
function noriks_flash_deals_banner() {
    ...
    ?>
    <div class="nfd" role="region" aria-label="Sommer-Sale">
      <div class="nfd-in">
        <div class="nfd-left">
          <p class="nfd-eyebrow">Saison-Rabatt</p>
          <div class="nfd-head">
            <h2 class="nfd-title">Sommer-Sale</h2>
            <?php if ( $off > 0 ) : ?>
              <span class="nfd-badge">-&minus;<?php echo (int) $off; ?>%</span>
            <?php endif; ?>
          </div>
          <p class="nfd-sub">Reduziert solange der Vorrat reicht</p>
        </div>

        <div class="nfd-right">
          <span class="nfd-cta">Angebot endet in</span>
          <div class="nfd-clock" id="nfd-clock" aria-live="off">
            <span class="nfd-unit"><b data-u="d">00</b><em>Tage</em></span>
            <span class="nfd-unit"><b data-u="h">00</b><em>Std</em></span>
