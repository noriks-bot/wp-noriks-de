 ...
 *
 * Poleg tega stevilko ob oddaji naročila tiho pretvori v mednarodno obliko (+49...),
 * ker je Metakocka del narocil zavracala samo zaradi presledkov in oklepajev.
 */

if ( ! defined( 'ABSPATH' ) ) { exit; }

define( 'NORIKS_TEL_CC',    '49' );
...
add_action( 'woocommerce_checkout_process', function () {
    ...
    if ( $p !== '' && ! noriks_tel_ok( $p ) ) {
        wc_add_notice( 'Bitte prüfen Sie die Telefonnummer — sie scheint unvollständig zu sein.', 'error' );
    }
}, 5 );
...
add_action( 'wp_footer', function () {
    ...
    jQuery(function($){
      var CC = '49', TRUNK = '0', MIN = 10, MAX = 13;
      var MSG = <?php echo wp_json_encode( 'Bitte prüfen Sie die Telefonnummer — sie scheint unvollständig zu sein.' . ' ' . 'z. B. 0151 23456789' ); ?>;
