...
function noriks_handle_add_upsell() {
    ...
    $_parent_product = ($variation_id && $product_id) ? wc_get_product($product_id) : $product;
    $product_name_lc    = strtolower( $_parent_product ? $_parent_product->get_name() : $product->get_name() );
