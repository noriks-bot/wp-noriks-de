...
/**
 * ============================================================
 * NORIKS — Central product-type resolver (DE)
 * ------------------------------------------------------------
 ...
 * unchanged; only the SLUG VALUES are German (+ universal orto-*).
 * ============================================================
 */
...
function noriks_product_type_map() : array {
    return array(
        ...
        'starter'   => array( 'starter-pakete', 'starter-paketi', 'orto-starter', 'orto-majica-bokserica' ),
        'majice'    => array( 't-shirts', 'majice', 'orto-tricka', 'orto-majice' ),
        'bokserice' => array( 'boxershorts', 'boxershorts-sets', 'bokserice', 'orto-bokserice', 'orto-bokserice2' ),
        'carape'    => array( 'socken', 'wintersocken', 'orto-kompresijske-carape' ),

        // --- sub-variants / special buckets ---
        'kompresijske-nogavice'   => array( 'socken', 'orto-kompresijske-carape' ),
        ...
        // KidsNest Kinderkissen für richtiges Atmen/Haltung (Needo-style).
