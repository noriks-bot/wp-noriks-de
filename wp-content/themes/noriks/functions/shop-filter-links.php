...
function noriks_shop_filter_map() {
	return apply_filters( 'noriks_shop_filter_map', array(
		'__shop__' => array(
			...
			'starter-pakete' => 'Starter-Pakete',
			'grosse-pakete' => 'Große Pakete',
		),
		'boxershorts' => array(
			'1-stueck-boxershorts' => '1 Stück',
			'3er-set-boxershorts' => '3er-Set',
			'5er-set-boxershorts' => '5er-Set',
			'7er-set-boxershorts' => '7er-Set',
			'10er-set-boxershorts' => '10er-Set',
			'15er-set-boxershorts' => '15er-Set',
			'schwarz' => 'Schwarz',
			'farben' => 'Farben',
		),
		'sets' => array(
		...
		'socken' => array(
			'schwarz-socken' => 'Schwarz',
			'weiss' => 'Weiße',
		),
		't-shirts' => array(
			'1-stueck-t-shirts' => '1 Stück',
			'3er-set-t-shirts' => '3er-Set',
			'6er-set-t-shirts' => '6er-Set',
			'9er-set-t-shirts' => '9er-Set',
			'12er-set-t-shirts' => '12er-Set',
			'15er-set-t-shirts' => '15er-Set',
			'schwarze-t-shirts' => 'Schwarz',
			'farben-t-shirts' => 'Farben',
		)
	) );
}
