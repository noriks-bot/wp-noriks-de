...
function noriks_controlpro_atc_testimonial() {
    ...
    <div class="cpr-atc-rev">
        <img class="cpr-atc-avatar" src="<?php echo esc_url( $avatar ); ?>" alt="Zufriedener NORIKS ControlPro Kunde" loading="lazy">
        <div class="cpr-atc-body">
            <p class="cpr-atc-text">„Nach meiner Prostata-OP habe ich zwei Jahre lang regelmäßig Kegelübungen gemacht und keinen größeren Fortschritt gesehen. Ich dachte, ich trage bis ans Lebensende Einlagen. Vier Wochen mit diesem Gerät und von 5 Einlagen täglich bin ich auf null."</p>
