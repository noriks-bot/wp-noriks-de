...
get_header(); ?>
  ...
  <div class="hero__content">
    ...
    <h1 class="hero__title">Das T-Shirt, das jedes Passformproblem loest.</h1>

    <a class="hero__btn" href="/de/shop">JETZT KAUFEN</a>
  </div>
</section>
...
@media (max-width: 640px) {
  ...
  <div class="collections__header">
    <h2 class="collections__title">Nach Kollektion shoppen</h2>

    <a class="collections__cta" href="/de/shop">
      Alle Produkte <span aria-hidden="true">›</span>
    </a>
  </div>
  ...
  <div class="collections__grid">
    ...
    <a class="collection-card" href="/de/product-category/boxershorts/">
      ...
      <div class="collection-card__body">
        <div class="collection-card__text">
          <div class="collection-card__topline">
            <h3 class="collection-card__name">Boxershorts</h3>
          </div>
          <p class="collection-card__desc">
          Weich. Atmungsaktiv. Zuverlaessig.
