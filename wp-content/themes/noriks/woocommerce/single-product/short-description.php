...
<div class="nhs-usp">
  <div class="nhs-usp-guarantee"><svg width="15" height="15" viewBox="0 0 24 24" style="flex:0 0 auto;"><circle cx="12" cy="12" r="12" fill="#7c3aed"/><path d="M7 12.5l3 3 7-7" fill="none" stroke="#fff" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"/></svg> 30-Tage-Geld-zurück-Garantie</div>
  <div class="nhs-usp-grid">
    <div><span class="nhs-usp-ic">≈</span> Reduziert Falten</div>
    <div><span class="nhs-usp-ic">↓</span> Reduziert feine Linien</div>
    <div><span class="nhs-usp-ic">♡</span> Mildert Narben über Nacht</div>
    <div><span class="nhs-usp-ic">✚</span> Zusätzlich haftend</div>
    <div><span class="nhs-usp-ic">✓</span> Wiederverwendbar und langlebig</div>
    <div><span class="nhs-usp-ic">↗</span> Fördert die Kollagenproduktion</div>
  </div>
</div>
<style>
  ...
  /* Countdown auf diesem Produkt: neutral grau (ohne Rot). */
  ...
  /* Discount badge (−33% …): lila auf diesem Produkt. */
  .gck-discount-badge { background: #7c3aed !important; color: #fff !important; }
  /* Bundle radio Buttons: lila auf diesem Produkt. */
...
<div class="kn2-badge">
  ...
  <span>Von Kinderärzten empfohlen</span>
</div>
<div class="kn2-below">
  <div class="kn2-trust">
    <span><svg width="16" height="16" viewBox="0 0 24 24"><path d="M12 2l8 3v6c0 5-3.5 9.5-8 11-4.5-1.5-8-6-8-11V5l8-3z" fill="#2b3fb0"/><path d="M8.5 12l2.5 2.5 4.5-4.5" fill="none" stroke="#fff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg> 90 Nächte Probeschlafen</span>
    <span><svg width="18" height="14" viewBox="0 0 24 18"><rect x="1" y="3" width="13" height="10" rx="1.5" fill="#2b3fb0"/><path d="M14 6h4l4 4v3h-8z" fill="#2b3fb0"/><circle cx="6" cy="15" r="2.4" fill="#1b2450"/><circle cx="18" cy="15" r="2.4" fill="#1b2450"/></svg> Schneller Versand</span>
    <span><svg width="17" height="15" viewBox="0 0 24 20"><rect x="3" y="2" width="18" height="11" rx="2" fill="none" stroke="#2b3fb0" stroke-width="2"/><circle cx="12" cy="7.5" r="2.6" fill="#2b3fb0"/><path d="M2 17c3 2 7 3 10 3s7-1 10-3" fill="none" stroke="#2b3fb0" stroke-width="2" stroke-linecap="round"/></svg> Auch Zahlung per Nachnahme</span>
  </div>
  <div class="kn2-redbox">
    <p class="kn2-red-title"><svg width="14" height="13" viewBox="0 0 24 22" style="vertical-align:-2px;margin-right:6px;"><path d="M12 1L23 21H1L12 1z" fill="none" stroke="#c0452f" stroke-width="2.4" stroke-linejoin="round"/><path d="M12 8v6" stroke="#c0452f" stroke-width="2.4" stroke-linecap="round"/><circle cx="12" cy="17.4" r="1.3" fill="#c0452f"/></svg>FÜR ELTERN VON KINDERN UNTER 9 JAHREN</p>
    <p class="kn2-red-body">Jede Nacht auf dem falschen Kissen <strong class="kn2-red">formt sich das Gesicht Ihres Kindes — in die falsche Richtung.</strong> Sabbern. Schnarchen. Offener Mund. Bis zum <strong class="kn2-red">9. Lebensjahr</strong> verfestigen sich die Veränderungen. Bis zum <strong class="kn2-red">14.</strong> — eine teure Zahnspange. Bis zum <strong class="kn2-red">18.</strong> — das Gespräch über ernsthaftere Eingriffe. Kinderzahnärzte mit Schwerpunkt Atemwege sehen das täglich — sie nennen es längst nicht mehr selten. <strong class="kn2-red">Wechseln Sie das Kissen noch heute Abend.</strong></p>
  </div>
</div>
<style>
  /* Badge iznad naslova */
...
(function(){
  function init(){
    ...
    /* Ribboni: strip ogenj + dodaj "Bester Wert" na 3. karto */
    document.querySelectorAll('.gck-popular-badge, .gck-popular-badge-2').forEach(function(b){ b.textContent=b.textContent.replace('🔥','').trim(); if(/Am beliebtesten/i.test(b.textContent)) b.textContent='Am beliebtesten'; });
    ...
    if(cards.length>=3 && !cards[2].querySelector('.kn2-ribbon') && !cards[2].querySelector('.gck-popular-badge, .gck-popular-badge-2')){
      var rb=document.createElement('div'); rb.className='kn2-ribbon'; rb.textContent='Bester Wert'; cards[2].appendChild(rb);
    }
...
<div class="oj-recpill">
  <img src="<?php echo esc_url( get_template_directory_uri().'/img/ortopedski-jastuk/04_lijecnik_HR.png' ); ?>" alt="Arzt" class="oj-recpill-av" onerror="this.style.display='none'">
  <span><strong>Empfohlen von Dr. Marić</strong>&nbsp;|&nbsp;<em>Wirbelsäulenspezialist</em></span>
...
<div class="oj-stockpill">
  ...
  <em>Nur noch wenige Stück auf Lager!</em>
</div>
...
<div class="oj-orders">
  ...
  <em><strong>128 Bestellungen</strong> in den letzten <strong>24 Stunden!</strong></em>
</div>
<style>
  ...
  /* Sakrij SAMO riječ "Gesamt:" u ponudama (cijene ostaju) */
  .bundle-total-line > span[style*="font-weight:normal"] { display: none !important; }
  ...
  /* "Bestellungen in 24h" red (zeleni pulsirajući krug) */
...
(function(){
  ...
  function movePills(){
    ...
    /* "Bestellungen in 24h" iznad ADD TO CART gumba */
...
<div class="ncl-trust">
  <span>Für kristallklares Glas und Duschen,</span>
  <span class="ncl-trust-stars">★★★★★</span>
  <span>vertrauen uns über 138.452 Haushalte</span>
</div>
<style>
