...
<div class="top-header">
  <div class="marquee">
    <div class="marquee-content">
      <span><a href="/de/shop"><?php echo $mq_ico_truck; ?>Kostenloser Versand ab 70 EUR</a></span>
      <span><a href="/de/shop"><?php echo $mq_ico_shield; ?>30 Tage ohne Risiko testen</a></span>
    ...
    <div class="navbar-right">
      ...
      <div class="cart-auto-icon">
        ...
        <?php if ( class_exists( 'WooCommerce' ) ) : ?>
            <a class="header-cart" href="/de/cart">
                <div class="cart-icon">
