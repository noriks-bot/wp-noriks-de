...
<meta name="title" content="Kauf abschliessen" />
<meta name="description" content="Alles, was Sie brauchen, an einem Ort. Entdecken Sie eine grosse Auswahl an Produkten zu attraktiven Preisen." />
<meta name="image" content="https://vigoshop.hr/app/themes/hsplus/images/favicon/vigoshop/mstile-310x310.png" />
<meta property="og:locale" content="hr" />
<meta property="og:type" content="website" />
<meta property="og:title" content="Kauf abschliessen" />
<meta property="og:description" content="Alles, was Sie brauchen, an einem Ort. Entdecken Sie eine grosse Auswahl an Produkten zu attraktiven Preisen." />
<meta property="og:image" content="https://vigoshop.hr/app/themes/hsplus/images/favicon/vigoshop/mstile-310x310.png" />
<meta property="og:image:alt" content="Vigoshop - Kauf abschliessen" />
...
<div class="before_form container container--xs">
  ...
  <form name="checkout" method="post" class="checkout woocommerce-checkout"
        action="#" enctype="multipart/form-data" aria-label="Zahlung">
    ...
    <h3 class="checkout-billing-title">Zahlung i Versand</h3>

  
  
  <div class="woocommerce-billing-fields__field-wrapper">
    <p class="form-row form-row-first form-group col-xs-12 validate-required" id="billing_first_name_field" data-priority="30"><label for="billing_first_name" class="required_field">Vorname&nbsp;<span class="required" aria-hidden="true">*</span></label><span class="woocommerce-input-wrapper"><input type="text" class="input-text form-input" name="billing_first_name" id="billing_first_name" placeholder="Vorname"  value="" aria-required="true" maxlength="80" autocomplete="given-name" /></span></p><p class="form-row form-row-last form-group col-xs-12 validate-required" id="billing_last_name_field" data-priority="40"><label for="billing_last_name" class="required_field">Nachname&nbsp;<span class="required" aria-hidden="true">*</span></label><span class="woocommerce-input-wrapper"><input type="text" class="input-text form-input" name="billing_last_name" id="billing_last_name" placeholder="Nachname"  value="" aria-required="true" maxlength="80" autocomplete="family-name" /></span></p><div class="form-row form-row-wide col-xs-12">Geben Sie die Adresse ein, unter der Sie <b>zwischen 8:00 und 16:00 Uhr</b> erreichbar sind.</div><p class="form-row form-row-wide address-field form-group form-group col-xs-12 validate-required" id="billing_address_1_field" data-priority="50"><label for="billing_address_1" class="required_field">Strasse&nbsp;<span class="required" aria-hidden="true">*</span></label><span class="woocommerce-input-wrapper"><input type="text" class="input-text form-input" name="billing_address_1" id="billing_address_1" placeholder="Strasse"  value="" aria-required="true" maxlength="80" autocomplete="address-line1" /></span></p><p class="form-row form-row-wide address-field form-group form-group col-xs-12 validate-required" id="billing_address_2_field" data-priority="60"><label for="billing_address_2" class="screen-reader-text required_field">Hausnummer&nbsp;<span class="required" aria-hidden="true">*</span></label><span class="woocommerce-input-wrapper"><input type="text" class="input-text form-input" name="billing_address_2" id="billing_address_2" placeholder="Hausnummer"  value="" autocomplete="address-line2" maxlength="80" aria-required="true" /></span></p><p class="form-row form-row-wide address-field form-group form-group col-xs-12 validate-required validate-postcode" id="billing_postcode_field" data-priority="70"><label for="billing_postcode" class="required_field">Postleitzahl&nbsp;<span class="required" aria-hidden="true">*</span></label><span class="woocommerce-input-wrapper"><input type="tel" class="input-text form-input" name="billing_postcode" id="billing_postcode" placeholder="Postleitzahl"  value="" aria-required="true" maxlength="30" autocomplete="postal-code" /></span></p><p class="form-row form-row-wide dropdown form-group form-group col-xs-12 validate-required" id="billing_city_field" data-priority=""><label for="billing_city" class="required_field">Stadt&nbsp;<span class="required" aria-hidden="true">*</span></label><span class="woocommerce-input-wrapper"><select name="billing_city" id="billing_city" class="select form-input" aria-required="true" data-allow_clear="true" data-placeholder="Stadt auswaehlen">
							<option value=""  selected='selected'>Stadt auswaehlen</option>
						</select></span></p><p class="form-row form-row-wide form-group col-xs-12 validate-required validate-phone" id="billing_phone_field" data-priority="10"><label for="billing_phone" class="required_field">Telefon&nbsp;<span class="required" aria-hidden="true">*</span></label><span class="woocommerce-input-wrapper"><input type="tel" class="input-text form-input" name="billing_phone" id="billing_phone" placeholder="Mobiltelefonnummer"  value="" maxlength="17" aria-required="true" autocomplete="tel" /></span></p><p class="form-row form-row-wide form-group col-xs-12 validate-email" id="billing_email_field" data-priority="20"><label for="billing_email" class="">E-Mail-Adresse&nbsp;<span class="optional">(optional)</span></label><span class="woocommerce-input-wrapper"><input type="email" class="input-text form-input" name="billing_email" id="billing_email" placeholder="E-Mail-Adresse"  value="" maxlength="80" autocomplete="email" /></span></p><p class="form-row form-row-wide address-field form-group col-xs-12 validate-state" id="billing_state_field" data-priority="80"><label for="billing_state" class="">Bundesland&nbsp;<span class="optional">(optional)</span></label><span class="woocommerce-input-wrapper"><select name="billing_state" id="billing_state" class="state_select form-input" autocomplete="address-level1" data-placeholder="placeholder_province"  data-input-classes="form-input" data-label="Bundesland">
						<option value="">Option auswaehlen&hellip;</option><option value="DE-BW">Baden-Wuerttemberg</option><option value="DE-BY">Bayern</option><option value="DE-BE">Berlin</option><option value="DE-BB">Brandenburg</option><option value="DE-HB">Bremen</option><option value="DE-HH">Hamburg</option><option value="DE-HE">Hessen</option><option value="DE-MV">Mecklenburg-Vorpommern</option><option value="DE-NI">Niedersachsen</option><option value="DE-NW">Nordrhein-Westfalen</option><option value="DE-RP">Rheinland-Pfalz</option><option value="DE-SL">Saarland</option><option value="DE-SN">Sachsen</option><option value="DE-ST">Sachsen-Anhalt</option><option value="DE-SH">Schleswig-Holstein</option><option value="DE-TH">Thueringen</option></select></span></p><p class="form-row form-row-wide address-field update_totals_on_change form-group col-xs-12 validate-required" id="billing_country_field" data-priority="90"><label for="billing_country" class="required_field">Country / Region&nbsp;<span class="required" aria-hidden="true">*</span></label><span class="woocommerce-input-wrapper"><strong>Deutschland</strong><input type="hidden" name="billing_country" id="billing_country" value="DE" aria-required="true" autocomplete="do-not-autofill" class="country_to_state" readonly="readonly" /></span></p><p class="form-row kl_newsletter_checkbox_field form-group col-xs-12" id="kl_newsletter_checkbox_field" data-priority=""><span class="woocommerce-input-wrapper"><label class="checkbox " ><input type="checkbox" name="kl_newsletter_checkbox" id="kl_newsletter_checkbox" value="1" class="input-checkbox form-input"  /> Sign me up to receive email updates and news&nbsp;<span class="optional">(optional)</span></label></span></p><p class="form-row form-row-wide hsplus-checkout-field hsplus-checkout-field--no-top-margin hsplus-checkout-field--hidden" id="hsplus_accepts_marketing_field" data-priority="11"><span class="woocommerce-input-wrapper"><label class="checkbox " ><input type="checkbox" name="hsplus_accepts_marketing" id="hsplus_accepts_marketing" value="1" class="input-checkbox woocommerce-form__input woocommerce-form__input-checkbox hsplus-checkbox"  /> Sign up for exclusive offers and news via text messages&nbsp;<span class="optional">(optional)</span></label></span></p>  </div>
...
<div class="woocommerce-additional-fields">
			...
			<h3>Zusaetzliche Informationen</h3>

		
		<div class="woocommerce-additional-fields__field-wrapper">
							<p class="form-row notes form-group col-xs-12" id="order_comments_field" data-priority=""><label for="order_comments" class="">Anmerkungen zur Bestellung&nbsp;<span class="optional">(optional)</span></label><span class="woocommerce-input-wrapper"><textarea name="order_comments" class="input-text form-input" id="order_comments" placeholder="Hinweise zu Ihrer Bestellung.  "  rows="2" cols="5"maxlength="80"></textarea></span></p>					</div>
	...
	<div id="custom_shipping">
        ...
        <ul class="shipping_method_custom">
                ...
                <label
                    ...
                    <svg viewBox="0 0 19 14" fill="#3DBD00"><path fill-rule="evenodd" clip-rule="evenodd" d="M18.5725 3.40179L8.14482 13.5874C7.5815 14.1375 6.66839 14.1375 6.1056 13.5874L0.422493 8.03956C-0.140831 7.48994 -0.140831 6.59748 0.422493 6.04707L1.44121 5.05126C2.00471 4.50094 2.91854 4.50094 3.48132 5.05126L7.12254 8.60835L15.5145 0.412609C16.078 -0.137536 16.9909 -0.137536 17.5537 0.412609L18.5733 1.40842C19.1424 1.95795 19.1424 2.8505 18.5725 3.40179Z" /></svg>                                        <div class="outer-wrapper">
                        ...
                        <strong
                            class="hs-custom-date">Mittwoch, 18.3. - Donnerstag, 19.3.</strong>
                        </div>
        ...
        <img decoding="async" class="delivery-from-eu-warehouse__icon"
            ...
            class="delivery-from-eu-warehouse__text">EU-Lager</span>
    </div>
    </div>
<div class="sup_outher_wrapper">
    ...
    <div class="surprise_upsells_wrapper">
                ...
                <div class="vigo-gift__tooltip">
                    <div class="flex flex--autosize flex--middle">
                        ...
                        <div class="flex__item f--bold">  Zur Bestellung hinzufuegen</div>
                    </div>
                </div>
                <div class="flex sup_inner_wrapper">
                    <div>
                        <div class="surprise_product_click flex flex--wrap flex--autosize flex--gaps flex--middle">
                            ...
                            <div class="f--l f--bold surprise_title">Ueberraschungsprodukt</div>
                        ...
                        <div class="f--m c--darkgray s-top--s">Im Wert zwischen 5 € und 15 €.</div>
                    </div>
  ...
  <label for="payment_method_cod">
    Zahlung per Nachnahme <span class="payment-fee-not-free"><span class="woocommerce-Price-amount amount">1,99<span class="woocommerce-Price-currencySymbol">&euro;</span></span></span><div class="hs-checkout__payment-method-cod-icon-container">
    ...
    Kreditkarte <span class="payment-fee-free">Kostenlos</span><div class="sv-wc-payment-gateway-card-icons"><img decoding="async" src="https://vigoshop.hr/app/plugins/woocommerce-gateway-paypal-powered-by-braintree/vendor/skyverge/wc-plugin-framework/woocommerce/payment-gateway/assets/images/card-visa.svg" alt="visa" class="sv-wc-payment-gateway-icon wc-braintree-credit-card-payment-gateway-icon" width="40" height="25" style="width: 40px; height: 25px;" /><img decoding="async" src="https://vigoshop.hr/app/plugins/woocommerce-gateway-paypal-powered-by-braintree/vendor/skyverge/wc-plugin-framework/woocommerce/payment-gateway/assets/images/card-mastercard.svg" alt="mastercard" class="sv-wc-payment-gateway-icon wc-braintree-credit-card-payment-gateway-icon" width="40" height="25" style="width: 40px; height: 25px;" /><img decoding="async" src="https://vigoshop.hr/app/plugins/woocommerce-gateway-paypal-powered-by-braintree/vendor/skyverge/wc-plugin-framework/woocommerce/payment-gateway/assets/images/card-maestro.svg" alt="maestro" class="sv-wc-payment-gateway-icon wc-braintree-credit-card-payment-gateway-icon" width="40" height="25" style="width: 40px; height: 25px;" /></div>  </label>
      ...
      <fieldset id="wc-braintree-credit-card-credit-card-form" aria-label="Zahlungsinformationen"><legend style="display:none;">Zahlungsinformationen</legend><div class="wc-braintree-credit-card-new-payment-method-form js-wc-braintree-credit-card-new-payment-method-form"><input type="hidden" name="wc-braintree-credit-card-card-type" value="" /><input type="hidden" name="wc-braintree-credit-card-3d-secure-enabled" value="" /><input type="hidden" name="wc-braintree-credit-card-3d-secure-verified" value="" /><input type="hidden" name="wc-braintree-credit-card-3d-secure-order-total" value="21.98" />		<input type="hidden" id="wc_braintree_credit_card_payment_nonce" name="wc_braintree_credit_card_payment_nonce" />
		<input type="hidden" id="wc-braintree-credit-card-device-data" name="wc_braintree_device_data" />
			...
			<label for="wc-braintree-credit-card-account-number-hosted">Kartennummer<abbr class="required" title="required">&nbsp;*</abbr></label>
			...
			<label for="wc-braintree-credit-card-expiry-hosted">Ablaufdatum<abbr class="required" title="required">&nbsp;*</abbr></label>
...
<li class="wc_payment_method payment_method_braintree_paypal">
  <input id="payment_method_braintree_paypal" type="radio" class="input-radio" name="payment_method" value="braintree_paypal"  data-order_button_text="Bestellen" />

  <label for="payment_method_braintree_paypal">
    PayPal <span class="payment-fee-free">Kostenlos</span><img decoding="async" src="https://images.vigo-shop.com/general/checkout/paypal/PayPal.svg" alt="PayPal">  </label>
      <div class="payment_box payment_method_braintree_paypal" style="display:none;">
      <fieldset id="wc-braintree-paypal-paypal-form" aria-label="Zahlungsinformationen"><legend style="display:none;">Zahlungsinformationen</legend><div class="wc-braintree-paypal-new-payment-method-form js-wc-braintree-paypal-new-payment-method-form">		<input type="hidden" id="wc_braintree_paypal_payment_nonce" name="wc_braintree_paypal_payment_nonce" />
		...
		<div class="woocommerce-terms-and-conditions-wrapper">
            ...
            <div class="cod-prompt-text">Schliessen Sie die Bestellung jetzt ab und <strong>zahlen Sie per Nachnahme 🙂</strong></div>
            ...
            <span class="tax-and-vat-checkout-claims">Die MwSt. ist im Preis enthalten</span>
        </div>
        <div id="pdf">
    <div class="pdf-title-container">
        <h3 class="pdf-title">
            E-BOOK KAUFEN<!--            <span class="green-label">-->
<!--                --><!--            </span>-->
        </h3>
    </div>
    <p class="pdf-description">Beim Kauf des E-Books entfallen die Versandkosten.</p>
...
<!--                </div>-->
            ...
            <div id="pdf-select-false" class="cell-grid column-selected top">
                ...
                <label for="ebook_false">Ich moechte kein E-Book</label>
            </div>
    ...
    <p class="pdf-more-info">
        ...
        <u>Mehr Informationen zum E-Book</u>
    </p>
    <p class="pdf-more-info-description">
        Waehlen Sie unser E-Book und erhalten Sie Zugang zu praktischen Tipps, Spartipps und weiteren Vorteilen. Zudem sparen Sie beim Versand.</p>
</div>


<h3 class="place-order-title" style="display: block;">Bestelluebersicht</h3>
<div class="vigo-checkout-total order-total shop_table woocommerce-checkout-review-order-table">
    <div class="grid m-top--s review-all-products-container">
        ...
        <div id="order_review" class="woocommerce-checkout-review-order container container--xs bg--white">
            <button type="submit" class="button alt button--l button--block button--green button--rounded button--green-gradient" name="woocommerce_checkout_place_order" id="place_order" data-value="Bestellen" />Bestellen</button></div><div class="checkout-warranty flex flex--center flex--middle">
    ...
    <div class="flex__item--autosize f--m checkout-warranty__text">
        ...
        Geld-zurueck-Garantie innerhalb von 30 Tagen    </div>
</div>

<div class="agreed_terms_txt">
    <span class="policy-agreement-obligation">Mit Klick auf <strong>Bestellen</strong> bestaetige ich eine zahlungspflichtige Bestellung.</span> <br>
            ...
            Ich habe die <a href="#" id="terms_conditions_link">Allgemeinen Verkaufsbedingungen</a> und das <a href="#" id="withdrawal_policy_link">Widerrufsrecht</a> gelesen und akzeptiere sie.        </div>
    </div>
...
<div id="terms-conditions-popup" class="checkout-popup" style="display: none;">
    <div class="checkout-popup-wrapper">
        <div id="terms-conditions-content">
            <h2 class="ql-align-justify"><strong>Allgemeine Geschaeftsbedingungen</strong></h2>
            <p class="ql-align-justify"><a class="button" href="#" style="background-color: lightgray">Speichern oder drucken</a></p>
            <p class="ql-align-justify">Diese Bestellseite wird von HS Plus d.o.o., Gmajna 8, SI-1236 Trzin, Slowenien betrieben.</p>
            <p class="ql-align-justify">Mit dem Absenden der Bestellung bestaetigen Sie, dass Sie Preise, Lieferbedingungen, Zahlungsbedingungen und Rueckgabehinweise gelesen haben und akzeptieren.</p>
            <p class="ql-align-justify">Alle Preise werden in EUR angezeigt. Verbindlich ist immer die Zusammenfassung, die unmittelbar vor dem Absenden der Bestellung im Checkout angezeigt wird.</p>
            <p class="ql-align-justify">Lieferzeiten sind Schaetzwerte und koennen sich aufgrund von Nachfrage oder Versanddienstleistern aendern.</p>
            <p class="ql-align-justify">Weitere Informationen zu Rueckgaben, Widerruf und Support finden Sie in den unten verlinkten Bereichen.</p>
            <p class="ql-align-justify"><strong>HS Plus d.o.o.</strong><br>Gmajna 8, SI-1236 Trzin, Slowenien</p>
        </div>
...
<div id="withdrawal-policy-popup" class="checkout-popup" style="display: none;">
    <div class="checkout-popup-wrapper">
        <div id="withdrawal-policy-content">
            ...
            <p class="ql-align-justify">Aus Hygiene-, Sicherheits- oder Personalisierungsgruenden koennen bestimmte Produkte vom Widerruf ausgeschlossen sein.</p>
        </div>
        <img decoding="async" id="close_withdrawal_policy" src="https://images.vigo-shop.com/general/remove.png" alt="Close">
    </div>
</div>

<div id="checkout-popup"><div id="checkout-popup">
            <div class="checkout-popup-wrapper">
                <img decoding="async" class="img-info" src="https://images.vigo-shop.com/general/vigoshop_info.svg">
                <span>HSplus d.o.o. darf die uebermittelten personenbezogenen Daten verwenden, um Ihnen personalisierte Informationen ueber Produkte, Angebote und Neuigkeiten per SMS, Telefon, Katalog oder E-Mail zu senden. Ihre Einwilligung koennen Sie jederzeit widerrufen. Weitere Informationen zu Ihren Datenschutzrechten finden Sie in den                     <span id="terms-conditions-content_email-checkbox">
                        ALLGEMEINEN GESCHAEFTSBEDINGUNGEN                    </span>.
                        <div class="terms-conditions-content_email" style="display: none;">
  <h2 class="ql-align-justify"><strong>Allgemeine Geschaeftsbedingungen</strong></h2>
  <p class="ql-align-justify"><a class="button" href="https://images.hs-plus.com/legal/terms-conditions/terms-conditions_Vigoshop_hr.pdf" style="background-color: lightgray">Speichern und drucken</a></p>
  <p class="ql-align-justify">Willkommen bei NORIKS. Diese Allgemeinen Geschaeftsbedingungen regeln die Nutzung des Onlineshops sowie den Kauf von Produkten ueber diese Checkout-Seite.</p>
  <p class="ql-align-justify">Mit Abschluss der Bestellung bestaetigen Sie, dass Sie die Bedingungen gelesen haben und ihnen zustimmen. Alle angegebenen Preise verstehen sich inklusive gesetzlicher Abgaben, sofern nicht anders angegeben.</p>
  <p class="ql-align-justify">Bestellungen werden nach erfolgreicher Uebermittlung und Bestaetigung bearbeitet. Lieferzeiten, Zahlungsarten, Rueckgabe- und Widerrufsrechte richten sich nach den jeweils auf der Website angegebenen Informationen und den geltenden Verbraucherschutzvorschriften.</p>
  <p class="ql-align-justify">Wenn Sie Fragen zu Ihrer Bestellung, zur Rueckgabe oder zum Widerruf haben, wenden Sie sich bitte an unseren Kundensupport. Zusaetzliche Informationen zu Datenschutz, Cookies und Verbraucherrechten finden Sie in den verlinkten Richtlinien im Footer dieser Seite.</p>
  <p class="ql-align-justify"><strong>HS PLUS d.o.o.</strong><br>Gmajna 8, SI-1236 Trzin, Slowenien</p>
</div>
</span>
    ...
    <div class="inner_wrapper">
        ...
        <div class="partial_inner_section">
            ...
            <div class="text_wrapper">
                Versand durch: DHL Paket            </div>
        </div>

                    <div class="partial_inner_section">
                <img src="https://images.vigo-shop.com/general/banner_icons/COD_icon.svg" alt="">
                <div class="text_wrapper">Zahlung per Nachnahme</div>
            </div>
            ...
            <div class="text_wrapper delivery-from-eu-warehouse__text">EU-Lager</div>
        </div>
            </div>
</div>
    ...
    <div class="footer-payment__content container container--l">
                ...
                <div class="footer-mobile-payment__links-content  s-left--s s-right--s s-bottom--m opened">
                    <div class="footer-main__links">
                        <ul>
                                    ...
                                    <a href="https://vigoshop.hr/opci-uvjeti-poslovanja/"
                                       class="button button--link c--gray">Allgemeine Geschaeftsbedingungen</a>
                                </li>
                                                            <li>
                                    <a href="https://vigoshop.hr/pravila-o-zastiti-privatnosti/"
                                       class="button button--link c--gray">Datenschutzerklaerung</a>
                                </li>
                                                            <li>
                                    <a href="https://vigoshop.hr/pravila-o-kolacicima/"
                                       class="button button--link c--gray">Cookie-Richtlinie</a>
                                </li>
                                                            <li>
                                    <a href="https://vigoshop.hr/pravo-na-odustajanje-od-kupnje/"
                                       class="button button--link c--gray">Widerrufsrecht</a>
                                </li>
                                                            <li>
                                    <a href="https://vigoshop.hr/prituzbe-i-sporovi/"
                                       class="button button--link c--gray">Beschwerden und Streitigkeiten</a>
                                </li>
                                                            <li>
                                    <a href="https://vigoshop.hr/zamjena-u-jamstvu/"
                                       class="button button--link c--gray">Garantieaustausch</a>
                                </li>
                                                            <li>
                                    <a href="https://vigoshop.hr/informacije-o-tvrtki/"
                                       class="button button--link c--gray">Unternehmensinformationen</a>
                                </li>
                                                            <li>
                                    <a href="https://manuals.hs-plus.com/hr?brand=vigoshop"
                                       class="button button--link c--gray">Gebrauchsanweisung</a>
                                </li>
                                                    </ul>
                    </div>
                </div>
                    ...
                    <a class="button button--link" id="scroll-to-top">
                        <div class="flex flex--autosize flex--middle flex--center">
                            ...
                            <div class="flex__item f--m c--lightgray scroll-to-top-text">Nach oben</div>
                        </div>
                    </a>
                </div>
                    </div>
        <div class="flex flex--autosize flex--apart footer-payment--wrapper">
            ...
            <path opacity="0.5" fill-rule="evenodd" clip-rule="evenodd" d="M10.9107 7.38848H11.6071C12.3761 7.38848 13 8.04356 13 8.85098V14.701C13 15.5084 12.3761 16.1635 11.6071 16.1635H1.39286C0.623884 16.1635 0 15.5084 0 14.701V8.85098C0 8.04356 0.623884 7.38848 1.39286 7.38848H2.08929V5.19473C2.08929 2.64145 4.0683 0.563477 6.5 0.563477C8.9317 0.563477 10.9107 2.64145 10.9107 5.19473V7.38848ZM4.41071 5.19473V7.38848H8.58928V5.19473C8.58928 3.98512 7.65201 3.00098 6.5 3.00098C5.34799 3.00098 4.41071 3.98512 4.41071 5.19473Z" fill="white"/>
                            ...
                            <div
                                class="flex__item f--bold c--gray">100% sicherer Einkauf</div>
                        </div>
                        <div
                            class="f--s c--gray">gesichert mit 256-Bit-Verschluesselung</div>
                    </div>
                </div>
            </div>
                ...
                <a class="button button--link" id="scroll-to-top">
                    <div class="flex flex--autosize flex--middle">
                        ...
                        <div class="flex__item f--m c--lightgray">Nach oben</div>
                    </div>
                </a>
            </div>
    ...
    <div class="wrapper">
        <div class='mobile-notice-modal__content'>
            ...
            <div class='mobile-notice-modal__head s-all--s'>
                <div class="f--l f--bold c--darkgray">Brauchen Sie Hilfe beim Kauf?</div>
            ...
            <div class="flex flex--vertical">
                    ...
                    <a class="  flex__item t--no-decoration c--text s-all--s" href="tel:+385-1-3300-004">
                        <div class="flex flex--autosize flex--gaps">
                            ...
                            <div class="flex__item desktop_contact desktop_phone_contact">Fuer Bestellungen rufen Sie an: <span class="phone-padding-top"><strong>01 3300 004</strong></span></div>
